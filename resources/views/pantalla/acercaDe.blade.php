				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="{{asset('pantalla/acercaDe')}}">Principal </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{asset('pantalla/acercaDe')}}">Acerca de Nosotros</a></p>
						</div>	
					</div>
				</div>
			</section>
					...
					<div class="row align-items-center">
						<div class="col-lg-6 home-about-left">
							...
							<div class="text-center">
								<a href="{{asset('almacen/inicio/create')}}" class="primary-btn">COMENZAR PEDIDO</h3></a>	
							</div>
							
						</div>
						<div class="col-lg-6 home-about-right">
							<img class="img-fluid" src="{{asset('pizzeria/FotoPDS.jpg')}}" alt="">
						</div>
					</div>
				</div>	
			</section>
